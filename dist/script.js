...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   LaravelCookieConsent: () => (/* binding */ LaravelCookieConsent)
/* harmony export */ });
...
var LaravelCookieConsent = /*#__PURE__*/function () {
  ...
  return _createClass(LaravelCookieConsent, [{
    key: "acceptAll",
    value: function acceptAll() {
      var _this = this;
      return this.request(this.config['accept.all']).then(function (response) {
        return _this.addScripts(response.data);
      });
    }
  }, {
    ...
    value: function acceptEssentials() {
      var _this2 = this;
      return this.request(this.config['accept.essentials']).then(function (response) {
        return _this2.addScripts(response.data);
      });
    }
  }, {
    key: "configure",
    value: function configure(data) {
      var _this3 = this;
      return this.request(this.config['accept.configuration'], data).then(function (response) {
        return _this3.addScripts(response.data);
      });
    }
  }, {
    key: "reset",
    value: function reset() {
      ...
      return this.request(this.config['reset']).then(function (response) {
        return _this4.addNotice(response.data);
      });
    }
  }, {
    key: "request",
    ...
    key: "addScripts",
    value: function addScripts(data) {
      if (!data.scripts) {
        return;
      }
      data.scripts.forEach(function (script) {
        ...
        var _iterator = _createForOfIteratorHelper(tmp.querySelector('script').attributes),
          _step;
        try {
    ...
    key: "addNotice",
    value: function addNotice(data) {
      if (!data.notice) {
        return;
      }
      var tmp = document.createElement('div');
      tmp.innerHTML = data.notice;
      var cookies = tmp.querySelector('#cookies-policy');
      document.body.appendChild(cookies);
      var tags = tmp.querySelectorAll('[data-cookie-consent]');
      if (!tags.length) {
        return;
      }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   LaravelCookieModal: () => (/* binding */ LaravelCookieModal)
/* harmony export */ });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var LaravelCookieModal = /*#__PURE__*/function () {
  function LaravelCookieModal(cookieConsentNotice, translations) {
    _classCallCheck(this, LaravelCookieModal);
    _defineProperty(this, "cookieConsentNotice", void 0);
  ...
  return _createClass(LaravelCookieModal, [{
    key: "getValues",
    ...
    value: function addEventListeners() {
      ...
      for (var i = 0; i < this.details.length; i++) {
        this.details[i].addEventListener('click', function (event) {
          return _this.toggleExpand(event, event.target, false);
        });
      }
    ...
    value: function configureCookies(event) {
    ...
    value: function acceptAllCookies(event) {
      event.preventDefault();
      window.LaravelCookieConsent.acceptAll();
      this.close();
    }
  }, {
    key: "acceptEssentialsCookies",
    value: function acceptEssentialsCookies(event) {
      event.preventDefault();
    ...
    value: function toggleExpand(event, el) {
      ...
      event.preventDefault();
      event.target.blur();
      var element = this.cookieConsentNotice.querySelector(el.getAttribute('href')),
    ...
    key: "changeText",
    value: function changeText(hide, isOpen, event) {
      if (hide) return;
      event.target.textContent = isOpen ? this.text.more : this.text.less;
    }
  }, {
    key: "hideNotice",
    value: function hideNotice(hide, isOpen) {
      if (!hide) return;
      var container = this.cookieConsentNotice.querySelector('.cookies__container'),
    ...
    value: function close() {
      ...
      setTimeout(function (cookie) {
        return function () {
          ...
          var scripts = _this2.cookieConsentNotice.parentNode.querySelectorAll('[data-cookie-consent]');
          scripts.forEach(function (script) {
            script.parentNode.removeChild(script);
          });
          _this2.cookieConsentNotice.parentNode.removeChild(cookie);
        };
      }(this.cookieConsentNotice), 210);
    }
  }, {
    key: "resetCookies",
    value: function resetCookies(event) {
      event.preventDefault();
...
/* harmony import */ var _Cookies__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Cookies */ "./resources/js/Cookies.js");


var cookieConsentNotice = document.querySelector('#cookies-policy');
var cookieConsentConfigScript = document.querySelector('#cookies-script');
if (cookieConsentNotice) {
  ...
  window.addEventListener('DOMContentLoaded', function () {
    var config = JSON.parse(cookieConsentConfigScript.getAttribute('data-config'));
    var text = JSON.parse(cookieConsentNotice.getAttribute('data-text'));
    window.LaravelCookieConsent = new _Cookies__WEBPACK_IMPORTED_MODULE_1__.LaravelCookieConsent(config);
    window.LaravelCookieModal = new _Modal__WEBPACK_IMPORTED_MODULE_0__.LaravelCookieModal(cookieConsentNotice, text);
