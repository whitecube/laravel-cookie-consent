...
var Cookies = /*#__PURE__*/function () {
  ...
  _createClass(Cookies, [{
    key: "acceptAll",
    value: function acceptAll(url) {
      this.request(url);
    }
  }, {
    key: "acceptEssentials",
    value: function acceptEssentials(url) {
      this.request(url);
    }
  }, {
    key: "configure",
    value: function configure(url, data) {
      this.request(url, data).then(function (response) {});
    }
  }, {
    key: "reset",
    value: function reset(url) {
      this.request(url).then(function (response) {
        var cookies = response.data.querySelector('.cookies');
...
var LaravelCookieConsent = /*#__PURE__*/function () {
  ...
  _createClass(LaravelCookieConsent, [{
    ...
    value: function initCookies() {
      this.cookiesConsent = new _Cookies__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  }, {
    key: "getElements",
    ...
    key: "changeText",
    value: function changeText(event, isOpen) {
      if (event.target.dataset.text) {
        var data = JSON.parse(event.target.dataset.text);
...
/******/ 	__webpack_require__.O(undefined, ["app"], () => (__webpack_require__("./resources/js/script.js")))
